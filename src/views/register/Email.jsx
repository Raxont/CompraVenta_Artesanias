...
export function Emailform() {
  ...
  const validateForm = () => {
		...
		if (!correo1) newErrors.correo1 = 'El correo es obligatorio';
		if (!correo2) newErrors.correo2 = 'Confirma tu correo';
		if (correo1 !== correo2) newErrors.correo2 = 'Los correos no coinciden';
  ...
  return (
    <>
      ...
      <form
        ...
        className="bg-white text-black min-h-screen min-w-fit flex-col justify-center pl-14 pr-12 pt-12 text-xl"
      >
        ...
        <div className="mb-5">
          <label className="block mb-2 text-primary dark:text-dark-bg">
            Nombre de usuario*
          </label>
          ...
          <input
            type="text"
            className="w-full p-2 border border-gray-300 bg-primary dark:bg-dark-tertiary rounded-lg mt-4"
            value={nombre}
        ...
        <div className="mb-4">
          ...
          <input
            type="email"
            className="w-full p-2 border border-gray-300 bg-primary dark:bg-dark-tertiary rounded-lg mb-2 z-10 relative"
            value={correo1}
            onChange={(e) => setCorreo1(e.target.value)}
            required
          />
          {errors.correo1 && <p className='text-red-500 text-sm'>{errors.correo1}</p>}
        </div>

        {/* Campo validar el correo */}
        <div className="mb-4">
          ...
          <input
            ...
            required
          />
          {errors.correo2 && <p className='text-red-500 text-sm'>{errors.correo2}</p>}
        </div>

        {/* Campo para ingresar la contraseña */}
        <div className="mb-4">
          <label className="block mb-1 text-primary dark:text-dark-bg">
            Contraseña*
          </label>
